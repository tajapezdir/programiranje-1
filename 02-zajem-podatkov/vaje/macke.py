...
cat_directory = 'C:\\Users\\Taja\\Documents\\FMF\\2. letnik\\programiranje 1\\programiranje-1\\02-zajem-podatkov\\vaje\\macki'
...
def save_frontpage(directory, filename):
    """Funkcija shrani glavno stran v datoteko"""
    vsebina = download_url_to_string(cats_frontpage_url)
...
def get_dict_from_ad_block(block):
    ...
    objave in ceni ter vrne slovar, ki vsebuje ustrezne podatke"""
    rx = re.compile(
        r'<h3.*>(?P<name>.*?)</a></h3>'
